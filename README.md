...
- **[content/](content/README.md)** — intake questions, content conventions, refining rules, and links to good-CV advice.
...
Start with the default template and the technical contract; consult styling and content to customize.
